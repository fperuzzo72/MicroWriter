"""Patch em crossink/src/network/FirmwareFlasher.cpp: protege o slot do
editor contra o autoupdate do próprio CrossInk.
...
o MicroWriter (o editor) está. Sem isso, um autoupdate do CrossInk
...
cópia antiga do próprio CrossInk), recusa a atualização antes de apagar
qualquer byte.
...
path = "crossink/src/network/FirmwareFlasher.cpp"
src = open(path).read()
...
h_path = "crossink/src/network/FirmwareFlasher.h"
