"""Patch em crosspoint/src/activities/home/HomeActivity.h: include + dois
campos novos.

Na 1.4 o include mudou para "activities/Activity.h" (sem "../").
"""

path = "crosspoint/src/activities/home/HomeActivity.h"
src = open(path).read()
