...
// Ported verbatim from MicroSlate
// (github.com/Josh-writes/microslate-firmware, src/dead_keys.h) — see
// NOTICE.md. Essential per project requirements; no changes from upstream.
//
// ---------------------------------------------------------------------------
