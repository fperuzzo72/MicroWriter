...
# --- Configuration ---
# The device advertises itself as "microwriter.local" (see wifi_sync.cpp's
# MDNS.begin call) — older versions used "microslate.local" or
# "microwriter-x4.local"; if this script can't reach the device, try one of
# those instead, or use its IP address directly (shown on the device's Sync
# screen).
DEVICE_URL = "http://microwriter.local"
